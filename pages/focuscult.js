      ...
      <Layout stroke="black">
        <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] px-[20px] md:px-0">
          <div className="flex flex-col md:flex-row pt-[25px] items-start gap-[16px] xl:w-[900px] py-[40px] md:py-[80px]">
            ...
            <div className="flex flex-col -mt-[15px] md:pr-[70px]">
              ...
              <div className="flex pt-[20px] justify-between w-[500px]">
                <div>
        ...
        <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-center justify-center pt-[95px]">
          <div className="flex flex-col items-center">
            <h2 className="w-[690px] text-center">{`Problem Context`}</h2>
            <p className="font-light 2xl:w-[1104px] text-center">
              {` In this digital era people are much empowered by convinience.
              Mobilephone are part of our everyday life, it’s undenyable that
              smartphone has aid our daily activity tremendously. With it’s good
              trait it also come with some bad trait to our daily life. This
              dependency on smartphone would soon turned into a smartphone
              addiction, that bring negative impact to our daily life. It’s
              proneness to disrupt both sleep and daily productivity.`}
              <br />
              <br />
              {`Focus cult
              is an initiative answer to lessen the impact of smarphone
              addiction by making its user close down the phone and record their
              choosen activity.`}
            </p>
          </div>
        </div>
        <div className="w-full bg-[#121212] mt-[90px] py-[55px] flex justify-center text-white">
          <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-start justify-center">
            ...
            <div className="flex items-center gap-[16px] pt-[20px]">
              <div className="w-[72px] border border-white border-opacity-50 mt-[4px]" />
            ...
            <div className="px-[88px]">
              ...
              <div className="flex flex-col gap-[10px] pt-[10px] pb-[30px]">
                <div className="flex gap-[15px] items-center">
                  <div className="w-[211px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    21.1%
                  </div>
                  <p className="pb-[2.5px] font-light">{`< 5 times`}</p>
                </div>
                <div className="flex gap-[15px] items-center">
                  <div className="w-[423px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    42.3%
                  </div>
                  <p className="pb-[2.5px] font-light">{`6-20 times`}</p>
                </div>
                <div className="flex gap-[15px] items-center">
                  <div className="w-[366px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    36.6%
                  </div>
              ...
              <div className="flex flex-col gap-[10px] pt-[10px] pb-[30px]">
                <div className="flex flex-col gap-[5px] justify-center">
                  <div className="w-[346px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    34.6%
                  </div>
                  <p className="pb-[2.5px] font-light">{`Doesn’t use their phone`}</p>
                </div>

                <div className="flex flex-col gap-[5px] justify-center">
                  <div className="w-[654px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    65.4%
                  </div>
              ...
              <div className="flex flex-col gap-[10px] pt-[10px] pb-[30px]">
                <div className="flex flex-col gap-[5px]">
                  <div className="w-[364px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    36.4%
                  </div>
                  <p className="pb-[2.5px] font-light">{`< 90 minutes`}</p>
                </div>
                <div className="flex flex-col gap-[5px]">
                  <div className="w-[338px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    33.8%
                  </div>
                  <p className="pb-[2.5px] font-light"> 90-120 minutes</p>
                </div>
                <div className="flex flex-col gap-[5px]">
                  <div className="w-[298px] h-[20px] bg-[#FFACA0] text-black flex items-center justify-center">
                    29.8%
                  </div>
        ...
        <div className="w-full pt-[90px] flex flex-col items-center justify-center ">
          <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-start justify-center">
            ...
            <div className="flex pt-[30px] px-[48px] w-full justify-between">
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="font-medium pt-[15px]">Deliverance & Evaluate</p>
                <p className="font-light text-center pt-[5px]">
                  Feedback
                  <br />
                  Revise
            ...
            <div className="px-[88px] pt-[90px]">
              <h2>User Research</h2>
              <p className="font-light">
                {` I conducted interviews on 15 participants and created empathy
                maps to understand the user that I’m designing for and their
                needs. There are 3 user groups that can be identified from this
                interview.`}
              </p>
              <ul className="font-bold list-disc list-inside pt-[15px]">
                Interview Goals
                <li className="pl-[8px]">
              ...
              <div className="relative pt-[30px]">
                ...
                <div className="flex pt-[5px] gap-[10px]">
                ...
                <div className="pt-[20px]">
                  ...
                  <div className="flex pt-[30px] justify-between">
                    <div className="flex flex-wrap w-[350px] gap-x-[15px] gap-y-[10px]">
                    ...
                    <div className="w-1/2">
                      <p>
                        {`Both teen / young adult who’s a scholar feels the
                  ...
                  <div className="flex pt-[45px] gap-[10px] items-center">
                    <div className="border p-[5px] border-[#379298] text-[#379298]">
                      Teen
                    </div>
                    <div className="border p-[5px] border-[#1A4F9D] text-[#1A4F9D]">
            ...
            <div className="px-[88px] pt-[90px]">
              ...
              <div className="bg-black rounded-[20px] mt-[32px] text-white flex items-center">
                <div className="2xl:px-[80px] py-[40px] flex flex-col ">
                  <div className="flex gap-[50px]">
                    ...
                    <div className="flex flex-col gap-[15px]">
                      <p className="font-semibold italic w-[600px] text-[20px]">
                        {`“I want to be able to focus both on my job and study
                        effectively during the day, and sleep effectively
                        without being distracted by my phone.”`}
                      </p>
                      <div className="flex">
                        <div className="relative">
                  ...
                  <div className="flex justify-between gap-x-[55px] py-[30px]">
                    ...
                    <ul className="font-light list-disc list-inside">
                      <p className="font-bold">FRUSTRATION</p>
                      <li className="pl-[8px]">
            ...
            <div className="px-[88px] pt-[90px]">
              ...
              <div className="flex justify-between pt-[30px]">
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="font-bold pt-[15px]">Accessible</p>
                  <p className="font-light w-[180px] pt-[5px]">
                    Present a clear and relevant information with clear
                    structure that assist users to achieve and comprehend data
                    easily.
                  </p>
                </div>
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="font-bold pt-[15px]">Seamless</p>
                  <p className="font-light w-[180px] pt-[5px]">
                    Present a clear and relevant information with clear
                    structure that assist users to achieve and comprehend data
                    easily.
                ...
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="font-bold pt-[15px]">Reliable</p>
                  <p className="font-light w-[180px] pt-[5px]">
                    Present a clear and relevant information with clear
                    structure that assist users to achieve and comprehend data
                    easily.
                ...
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="font-bold pt-[15px]">Flexible</p>
                  <p className="font-light w-[180px] pt-[5px]">
                    Present a clear and relevant information with clear
                    structure that assist users to achieve and comprehend data
                    easily.
            ...
            <div className="px-[88px] pt-[90px] w-full">
            ...
            <div className="px-[88px] pt-[90px] w-full">
              ...
              <div className="-mx-[40px] flex flex-wrap gap-x-[20px] gap-y-[24px] justify-center py-[30px]">
                <div className="bg-[#545454] text-[#f0f0f0] h-[36px] px-[5px] flex  items-center">
              ...
              <div className="flex flex-col">
                <div className="flex justify-between">
                  <ul className="font-light list-disc list-inside w-1/2">
          ...
          <div className="w-full bg-black text-white flex flex-col items-center justify-center py-[55px] mt-[90px]">
            <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-start justify-center">
              <div className="px-[88px]">
                ...
                <p className="font-light pb-[30px]">
          ...
          <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-start justify-center pt-[90px]">
            <div className="px-[88px] w-full">
              <h2 className="pb-[30px]">Typography & Colors</h2>
              <div className="relative">
              ...
              <h2 className="pb-[30px] pt-[90px]">Design System</h2>
              ...
              <div className="flex w-full ">
                <div className="flex flex-col w-1/2">
                  <div className="flex gap-[37px]">
                    <div className="flex flex-col items-start">
                      ...
                      <div className="relative">
                        <div className="w-[139px] aspect-[3.089] drop-shadow-xl">
                          <Image
                            src={`/focus/but1.png`}
                            alt="focus cult image"
                            fill
                      ...
                      <p className="pb-[15px] pt-[30px]">Icon</p>
                      <div className="relative">
                        <div className="w-[160px] aspect-[2.107]">
                          <Image
                            src={`/focus/icon.png`}
                            alt="focus cult image"
                            fill
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <p className="pb-[15px] pt-[30px]">Radio Button</p>
                      <div className="relative">
                ...
                <div className="w-1/2 flex flex-col items-start">
                  ...
                  <div className="relative">
                    <div className="w-[334px] aspect-[1.909] drop-shadow-xl">
                      <Image
              ...
              <h2 className="pt-[90px]">Illustration</h2>
              <div className="relative -mx-[88px]">
          ...
          <div className="w-full bg-black text-white flex flex-col items-center justify-center py-[55px]">
            <div className="w-full max-w-[500px] md:max-w-[640px] lg:max-w-[840px] xl:max-w-[980px] 2xl:max-w-[1280px] flex flex-col items-start justify-center">
              <div className="px-[88px]">
            ...
            <div className="relative w-full">
              <div className="w-full aspect-[1.117]">
                <Image
